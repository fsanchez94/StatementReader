...
class TestPDFProcessor:
    ...
    @patch('utils.pdf_processor.pytesseract.image_to_string')
    @patch('utils.pdf_processor.Image.open')
    @patch('utils.pdf_processor.pdfplumber.open')
    ...
    @patch('utils.pdf_processor.PDFProcessor._process_with_ocr')
    @patch('utils.pdf_processor.PDFProcessor._extract_text')
